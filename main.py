...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 3:
        print("Usage: SKI {local, qa, prod} {load_date} : Arguments are missing")
        sys.exit(-1)

    job_run_env = sys.argv[1].upper()
    load_date = sys.argv[2]
    job_run_id = "SKI-" + str(uuid.uuid4())

    print("Initializing SKI Job in " + job_run_env + " Job ID: " + job_run_id)
    ...
    logger.info("Reading SKI Account DF")
    ...
    logger.info("Reading SKI Party DF")
    ...
    logger.info("Reading SKI Address DF")
